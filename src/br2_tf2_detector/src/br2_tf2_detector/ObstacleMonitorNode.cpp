// Add missing constructor definition for ObstacleMonitorNode if not present
#include <memory>
...
namespace br2_tf2_detector{
    ...
    ObstacleMonitorNode::ObstacleMonitorNode() : Node("obstacle_monitor"),
        tf_buffer_(),
    ...
    void ObstacleMonitorNode::control_cycle(){
        ...
        try{
            ...
            RCLCPP_WARN(get_logger(), "Obstacle transform not found: %s",e.what());
            return;
        }
